...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("info.litegoldcoin.net", "pool.litegoldcoin.net"));
        vSeeds.push_back(CDNSSeedData("litegoldcoin.net", "seeds.litegoldcoin.net"));
        vSeeds.push_back(CDNSSeedData("seeds1.litegoldcoin.net", "seeds2.litegoldcoin.net"));
        vSeeds.push_back(CDNSSeedData("seeds3.litegoldcoin.net", "faucet.litegoldcoin.net"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("45.55.83.111", "159.203.111.166"));
