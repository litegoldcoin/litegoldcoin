...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(kLGC);
    unitlist.append(LGC);
    unitlist.append(litego);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    case kLGC: return QString("kLGC");
    case LGC: return QString("LGC");
    case litego: return QString("litego");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MLGC: return QString("Mega-LiteGoldCoin (1,000,000 LGC)");
    case kLGC: return QString("Kilo-LiteGoldCoin (1000 LGC)");
    case LGC: return QString("LiteGoldCoin");
    case litego: return QString("litego (1 / 100,000,000");
    default: return QString("???");
    }
}
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MLGC: return Q_INT64_C(100000000000000);
    case kLGC: return Q_INT64_C(100000000000);
    case LGC:  return Q_INT64_C(100000000);
    case litego: return Q_INT64_C(1);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MLGC: return Q_INT64_C(900000);
    case kLGC: return Q_INT64_C(900000000);
    case LGC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
    case litego: return Q_INT64_C(9000000000000000000); // Slightly under max value for int64
    default:   return 0;
    }
}
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MLGC: return 6;  // 900,000 (# digits, without commas)
    case kLGC: return 9;  // 900,000,000
    case LGC:  return 12; // 900,000,000,000
    case litego: return 19; // 9,000,000,000,000,000,000
    default: return 0;
    }
}
