# LiteGoldCoin Core 1.8.1

LiteGoldCoin Core 1.8.1 is primarily a bugfix release, bringing LiteGoldCoin Core in
line with Bitcoin 0.9.3. LiteGoldCoin Core 1.8.1 also adds in support for printing
...
* Disable Transifex based translation process (not used by LiteGoldCoin Core)
* Add checkpoints around AuxPoW switchover block (371,337)
* Disable connections from pre-1.8 LiteGoldCoin Core clients
...
There is a known issue with quantities in JSON used by the RPC interface (https://github.com/litegoldcoin/litegoldcoin/issues/134).
