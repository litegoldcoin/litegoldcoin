...
# Copyright (c) 2014 The LiteGoldCoin Core developers
...
BITCOIND=${1}/litegoldcoind
CLI=${1}/litegoldcoin-cli
...
# B1 should still be able to spend 1000000 (-1 LGC fee for the successful transaction), because D is conflicted
